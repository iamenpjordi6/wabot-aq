      ...
      for (let name in global.plugins) {
        ...
        if ((usedPrefix = (match[0] || '')[0])) {
          ...
          if (plugin.level > _user.level) {
            this.reply(m.chat, `This ${plugin.level} level is required to use this command. Your Level is ${_user.level}`, m)
...
global.dfail = (type, m, conn) => {
  let msg = {
    rowner: 'This command is only for _*OWWNER!1!1!*_',
    owner: 'This command is only for _*Owner Bot*_!',
    mods: 'This command is only for _*Moderator*_ !',
    premium: 'This command is only for_*Premium*_  user!',
